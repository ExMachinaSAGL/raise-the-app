...
describe('RaiseTheApp.vue', () => {
  ...
  it('should render correct contents', () => {
    expect(utils.getElement(vm, '.raisetheapp .notifications-toggle')).to.exist;
    expect(utils.getElement(vm, '.raisetheapp notifications-view')).to.not.exist;
  });
